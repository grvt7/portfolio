...
import ActiveSectionContextProvider from '@/context/active';
import { Toaster } from 'react-hot-toast';
import Footer from '@/components/footer';
import ThemeSwitch from '@/components/theme-switch';
import ThemeConextProvider from '@/context/theme-context';

const inter = Inter({ subsets: ['latin'] });

export const metadata: Metadata = {
  title: 'Garvit | Personal Portfolio',
  description: 'Garvit is a Full Stack Developer with 2+ years of experience',
};
