  ...
  return (
    <button
      ...
      className="group flex items-center justify-center gap-2 h-[3rem] w-[8rem] bg-gray-900 
          text-white rounded-full outline-none transition-all focus:scale-110 hover:scale-110 hover:mx-2
          active:scale-105 hover:bg-gray-950 disabled:bg-opacity-65
